...
<script>
 $("#find_addr").suggestions({
  ...
  token: "062315354b4b0e3b32049022c7ac5a498eef532f ",
  type: "ADDRESS",
...
?>	
	...
	<div class="row">
		<div class="col-sm-6">
			<a class="btn btn-default various fancybox.iframe" data-fancybox-type="iframe" href="<?php echo Url::toRoute("/tovar/popup1") ?>">Добавить товар</a>
		</div>			
	</div>
