...
<div class="order-form">
	...
	<fieldset>
		<legend><?= Html::a('<span class="glyphicon glyphicon-chevron-up" aria-hidden="true"></span>Клиент #'.$model->client_id,'#',array('class'=>'client-block')) ?></legend>
	...
	<div class="row">
	 	...
	 	<div class="col-md-6">
			...
			$('.client-block').click(function(){
				$('#client-block').toggle();
				$('.client-block span').toggleClass('glyphicon-chevron-up glyphicon-chevron-down');
				return false;
			});")
			?>
	...
	<fieldset>
		<legend><?= Html::a('<span class="glyphicon glyphicon-chevron-up" aria-hidden="true"></span>Отправка','#',array('class'=>'sender-block')) ?></legend>
	
	<?$this->registerjs("
		$('.sender-block').click(function(){
			$('#sender-block').toggle();
			$('.sender-block span').toggleClass('glyphicon-chevron-up glyphicon-chevron-down');
			return false;
		});")
	?>
	
	<div id="sender-block" style="display:none">
	...
	<fieldset>
		<legend><?= Html::a('<span class="glyphicon glyphicon-chevron-up" aria-hidden="true"></span>Доставка','#',array('class'=>'dostavlen-block')) ?></legend>
	
	<?$this->registerjs("
		$('.dostavlen-block').click(function(){
			$('#dostavlen-block').toggle();
			$('.dostavlen-block span').toggleClass('glyphicon-chevron-up glyphicon-chevron-down');
			return false;
		});")
	?>
	
	<div id="dostavlen-block" style="display:none">	
    ...
    <fieldset>
		<legend><?= Html::a('<span class="glyphicon glyphicon-chevron-up" aria-hidden="true"></span>Оплата','#',array('class'=>'oplachen-block')) ?></legend>
	
	<?$this->registerjs("
		$('.oplachen-block').click(function(){
			$('#oplachen-block').toggle();
			$('.oplachen-block span').toggleClass('glyphicon-chevron-up glyphicon-chevron-down');
			return false;
		});")
	?>
	
	<div id="oplachen-block" style="display:none">	
   ...
   <fieldset>
		<legend><?= Html::a('<span class="glyphicon glyphicon-chevron-up" aria-hidden="true"></span>Возврат','#',array('class'=>'vozvrat-block')) ?></legend>
	
	<?$this->registerjs("
		$('.vozvrat-block').click(function(){
			$('#vozvrat-block').toggle();
			$('.vozvrat-block span').toggleClass('glyphicon-chevron-up glyphicon-chevron-down');
			return false;
		});")
	?>
	
	<div id="vozvrat-block" style="display:none">	
