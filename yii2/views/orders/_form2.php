    ...
    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
		...
		<div class="panel panel-default">
    		<div class="panel-heading" role="tab" id="head-sender-block">
      			<h4 class="panel-title">
        			<a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#sender-block" aria-expanded="false" aria-controls="sender-block">Отправка <?=!empty($model->data_otprav) ? '['.Yii::$app->formatter->asDate($model->data_otprav).']' : '' ?></a>
        		</h4>
        	</div>
		...
		<div class="panel panel-default">
    		<div class="panel-heading" role="tab" id="head-dostavlen-block">
      			<h4 class="panel-title">
        			<a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#dostavlen-block" aria-expanded="false" aria-controls="dostavlen-block">Доставка <?=!empty($model->data_dostav) ? '['.Yii::$app->formatter->asDate($model->data_dostav).']' : '' ?></a>
        		</h4>
        	</div>
		...
		<div class="panel panel-default">
    		<div class="panel-heading" role="tab" id="head-oplachen-block">
      			<h4 class="panel-title">
        			<a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#oplachen-block" aria-expanded="false" aria-controls="oplachen-block">Оплата <?=!empty($model->data_oplata) ? '['.Yii::$app->formatter->asDate($model->data_oplata).']' : '' ?></a>
        		</h4>
        	</div>
		...
		<div class="panel panel-default">
    		<div class="panel-heading" role="tab" id="head-vozvrat-block">
      			<h4 class="panel-title">
        			<a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#vozvrat-block" aria-expanded="false" aria-controls="vozvrat-block">Возврат <?=!empty($model->data_vozvrat) ? '['.Yii::$app->formatter->asDate($model->data_vozvrat).']' : '' ?></a>
        		</h4>
        	</div>
...
function openWin()
{
	window.open('<?php echo Url::to("/tovar/popup") ?>', 'joe', config ='height = 90%,width = 90%')
