...
class User extends ActiveRecord implements IdentityInterface//, UserRbacInterface
{
	...
	*/
    ...
    public function getShops($id=false)
    {
        if($id === false) {
        	return $this->hasMany(Shops::className(), ['id' => 'shop_id'])->viaTable('user_shops', ['user_id' => 'id'])->inverseOf('users');
        }
        else {
			return \app\models\UserShops::find()->select(['shop_id'])->where(['user_id' => Yii::$app->user->id, 'shop_id' => $id])->asArray()->all();
		}
